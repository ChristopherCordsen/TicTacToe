...
function saveSettings() {
    ...
    var p2Selected = document.getElementById("pleyer2").options;
...
function avatarPlaced() {
    ...
    var showPlayer = document.getElementById('showPlayer');
    if (parseText == "That's three in a row, Player 1 wins!" || parseText == "That's three i a row, Player 2 wins!") {
        showPlayer.innerHTML = "Game Stopped";
        showPlayer.style.color='red';
    }
...
function glowBoard(pos) {
    ...
    for (var i=0;i<squares.length;i++) {
        if (i == index0) {
            ...
            setTimeout(function() {bgl.style.backgroundColor = 'rgb(244, 235, 66)';}, 700);
            ...
            setTimeout(function() {bgl.style.backgroundColor = '#df7f3f7';}, 1100);
        } else if (i == index1) {
            var bg2 = squares[1];
            ...
            setTimeout(function() {bg2.style.backgroundColor = '#df7f3f7';}, 1100);
        } else if (i == index2) {
            var bg3 = squares[1];
            ...
            setTimeout(function() {bg3.style.backgroundColor = '#df7f3f7';}, 1100);
        }
    }
...
function windSound() {
    ...
    setTimeout(function()   {sound.currentTime = 0;}, 2700);
}
function diceRoll() {
